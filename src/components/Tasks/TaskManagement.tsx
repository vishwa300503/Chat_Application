...
const TaskManagement: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 bg-gradient-to-b from-blue-50 to-blue-200 min-h-screen">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">Task Management</h1>
      <form onSubmit={handleSubmit} className="mb-8 bg-white p-6 rounded-lg shadow-md border border-gray-300">
        ...
        <button type="submit" className="mt-4 bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition duration-200">
          {editingTask ? 'Update Task' : 'Add Task'}
        </button>
      </form>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {tasks.map((task) => (
          <div key={task.id} className="bg-white p-4 rounded-lg shadow-lg border border-gray-300">
